...
<p>GET IN TOUCH WITH U.S., WE HOPE YOUR SUGGESTIONS<P>
...
<body>
<form id="form1" name="form1" method="post" action="enviarin.php">
  <P><label>
    <p align="left">NAME
  ...
  <P align="left"><label>
    <p align="left">PHONE
        <input name="telefono" type="text" id="telefono" size="12" />
      </p>
  </label>
  </P>
  <P align="left"><label>
  ...
  <P align="left"><label>
    <p align="left">SUBJECT<br />
        <textarea name="asunto" cols="27" rows="15" id="asunto"></textarea>
      </p>
  </label>
  </P>
  <div align="center">
