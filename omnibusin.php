...
<title>Omnibus Teotihuacan</title>
<!-- InstanceEndEditable -->
...
<div class="container">
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="ContenidoIzquierda" --> <br />
  <br />
   <br />
  ...
  <div class="content"><!-- InstanceBeginEditable name="ContenidoCentral" -->
    <h1>Bus Teotihuacan</h1>
    
<img width="350" height="200" alt="" src="IMAGENES/OMNIBUS.JPG" complete="complete"/>
</p><u>ROUTES AND DESTINATIONS</u></P><BR />
  *TEXCOCO *PACHUCA *TULANCINGO *OTUMBA *CENTRAL DEL NORTA *METRO I. VERDES *METRO M. CARRERA
  <!-- InstanceEndEditable -->
  <!-- end .content --></div>
  <div class="sidebar2"><!-- InstanceBeginEditable name="ContenidoDerecha" -->
    <P>With service hours from 4:00 am to 11:00 pm and Omnibus units provide a service type with different routes to our terminals, covering 100% all our routes.
